 ...
 */
class BlockerAttempt extends \PoradnikPiwny\Entities\BlockerAttempt implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::incrementAttempts();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'ip', 'dateExpired', 'attempts', 'aclResgroup');
    }
