 ...
 */
class Session extends \PoradnikPiwny\Entities\Session implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'key', 'value', 'dateCreated', 'dateExpired', 'ip', 'useragent', 'user');
    }
