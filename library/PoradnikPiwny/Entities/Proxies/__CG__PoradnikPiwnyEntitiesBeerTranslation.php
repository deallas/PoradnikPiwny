 ...
 */
class BeerTranslation extends \PoradnikPiwny\Entities\BeerTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'description', 'lang', 'beer');
    }
