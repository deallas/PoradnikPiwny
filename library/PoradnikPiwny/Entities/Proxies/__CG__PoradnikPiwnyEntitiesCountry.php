 ...
 */
class Country extends \PoradnikPiwny\Entities\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setIso2Code($iso2Code);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'urlName', 'iso2Code', 'iso3Code', 'beers', 'beerSearches');
    }
