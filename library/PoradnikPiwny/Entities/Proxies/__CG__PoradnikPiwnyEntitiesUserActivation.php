 ...
 */
class UserActivation extends \PoradnikPiwny\Entities\UserActivation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'dateAdded', 'dateExpired', 'uuid', 'type', 'user');
    }
