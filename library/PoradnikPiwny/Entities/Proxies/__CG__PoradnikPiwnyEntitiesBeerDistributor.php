 ...
 */
class BeerDistributor extends \PoradnikPiwny\Entities\BeerDistributor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'urlName', 'beers', 'beerManufacturers', 'beerSearches');
    }
